"""
Ulta Beauty Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Ulta Beauty.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/ulta
"""
...
# Set your Web Scraper ID after building your Ulta Beauty scraper:
# https://brightdata.co.kr/products/web-scraper/ulta
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Ulta Beauty scraper at: https://brightdata.co.kr/products/web-scraper/ulta\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Ulta Beauty product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Ulta Beauty products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Ulta Beauty category page.

    Example:
        results = discover_by_category("https://ulta.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.ulta.com/product/sample-item-123456",
        # Add more Ulta Beauty product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "ulta_prices.json"
    ...
    # cat_results = discover_by_category("https://ulta.com/category/sample", limit=50)
